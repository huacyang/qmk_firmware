...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        KC_ESC,  KC_BRID, KC_BRIU, KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MPRV, KC_MPLY,   KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_HOME,          KC_BTN1,
    ...
    [1] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,    KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,          KC_BTN2,
...
const uint8_t capKeys[] = {3, 8, 9, 10, 14, 15, 16, 20, 21, 22, 25, 26, 27, 30, 31, 32, 36, 37, 38, 41, 42, 43, 46, 47, 52, 53, 58, 67, 68, 70, 71, 73, 74, 76, 77, 80, 81, 83, 84, 87, 88, 91};
const uint8_t layerOneKeys[] = {7, 14, 15, 16, 38, 67, 68, 70, 71, 73, 74, 76, 77, 79, 80, 81, 83, 84, 87, 88, 91, 93, 94, 95, 97};
    ...
    // special handling per layer
        case 0:  //layer one
            if (host_keyboard_led_state().caps_lock) {
                ...
                for (int i = 0; i < sizeof(capKeys); i++) {
                    rgb_matrix_set_color(capKeys[i], 255, 0, 0);
                }
            }
            break;
        case 1:
            ...
            for (int i = 0; i < sizeof(layerOneKeys); i++) {
                rgb_matrix_set_color(layerOneKeys[i], 0, 0, 255);
            }
            break;
        default:
            break;
